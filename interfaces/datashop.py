...
class tree(manager):
    ...
    def refill(self):
        ...
        while True:
            ...
            dirparent,dirname = os.path.split(root)

            parent = parents_link[parents_name.index(dirparent)]

            link = self.tree.insert(parent,'end',iid=counter,text=dirname)
            counter += 1

...
%  2. Elliptic Theta Function of Third Kind, page 6.
%  3. Integral of Elliptic Theta Function of Third Kind, page 7.
%
...
% ---------------------------------------------------------------------- %
  ...
  methods (Static)
    ...
    function array = line(obs,src,tau,res)
        ...
        H1x = green.thetaAssembly('x',obs,src.p1,tau,res,'');
        H1y = green.thetaAssembly('y',obs,src.p1,tau,res,'');
        H1z = green.thetaAssembly('z',obs,src.p1,tau,res,'integral');
        
        array = cons*(H1x.p+H1x.m).*(H1y.p+H1y.m).*(H1z.p-H1z.m);
    ...
    function array = plane(obs,src,tau,res,str)
        ...
        switch nargin
            ...
            if strcmp(str,'xz')
                ...
                H1x = green.thetaAssembly('x',obs,src.p1,tau,res,'integral');
                H2x = green.thetaAssembly('x',obs,src.p2,tau,res,'integral');
                H1y = green.thetaAssembly('y',obs,src.p1,tau,res,'');
                H1z = green.thetaAssembly('z',obs,src.p1,tau,res,'integral');
            ...
            elseif strcmp(str,'yz')
                ...
                H1x = green.thetaAssembly('x',obs,src.p1,tau,res,'');
                H1y = green.thetaAssembly('y',obs,src.p1,tau,res,'integral');
                H2y = green.thetaAssembly('y',obs,src.p2,tau,res,'integral');
                H1z = green.thetaAssembly('z',obs,src.p1,tau,res,'integral');
            ...
            var.Xcoord = src.p1.Xcoord+src.signX.*dl.*cos(src.azimuth);
            var.Ycoord = src.p1.Ycoord+src.signY.*dl.*sin(src.azimuth);
